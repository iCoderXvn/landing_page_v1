...
import { Eye, EyeOff, Bold, Italic, Image, List, Quote, Trash2, Settings, Plus, Edit, Tags, Link, ExternalLink, Type } from "lucide-react";
...
export default function AdminPage() {
  ...
  // Check for existing session and load posts on component mount
  useEffect(() => {
                  ...
                  <div>
                    ...
                    <div className="flex justify-between items-center mt-2">
                      <p className="text-sm text-gray-400">
                        Use markdown formatting: **bold**, *italic*, # heading, &gt;quote, - list
                      </p>
