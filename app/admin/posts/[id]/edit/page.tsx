...
export default function EditPostPage() {
  ...
  const handleUpdate = async (showMessage = true) => {
    if (!validateForm()) {
      return;
    }
                ...
                <div>
                  ...
                  {saveStatus && (
                    <div className="flex items-center gap-2 mt-1">
                      {saveStatus === "saving" && (
                        <span className="text-sm text-yellow-400">Saving changes...</span>
                      )}
                      {saveStatus === "saved" && (
...
// Preview helper used to match public blog rendering (innerHTML + VideoPlayer mounting)
